...
function linksConfigMenu()
{
    ...
    $result2 = $GLOBALS['xoopsDB']->queryF('SELECT lid, title FROM ' . $xoopsDB->prefix('flashgames_games') . ' ORDER BY title');
    ...
    while ($game = $GLOBALS['xoopsDB']->fetchArray($result2)) {
...
function myLinksConfigAdmin()
{
    ...
    global $flashgames_scoresave, $flashgames_scoreshow;  // OKa
    ...
    // Max. Anzahl zu speichernder Highscoreränge

    echo '<tr><td nowrap> Max. Anz. zu speichernder Ränge </td><td>';
    ...
    // Anzahl anzuzeigender Highscoreränge

    echo '<tr><td nowrap> Max. Anz. anzuzeigender Ränge </td><td>';
